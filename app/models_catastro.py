...
class Servidumbres(models.Model):
    # id = models.BigAutoField(primary_key=True)  # Django lo crea automáticamente si no se especifica
    expediente = models.IntegerField(null=True, blank=True)
    superficie = models.TextField(null=True, blank=True)
    jerarquia = models.TextField(null=True, blank=True)
    tipo_serv = models.TextField(null=True, blank=True)
    concesionario = models.TextField(null=True, blank=True)
    pertenece_a = models.TextField(null=True, blank=True)
    fecha_inicio = models.DateTimeField(null=True, blank=True)
    fecha_aprobacion_mensura = models.DateField(null=True, blank=True)
    fecha_publicacion_archivo = models.DateField(null=True, blank=True)
    remsa = models.CharField(max_length=1, null=True, blank=True)
    ...
    nro_orden = models.SmallIntegerField(null=True, blank=True)
    estado = models.TextField(null=True, blank=True)
    observaciones = models.TextField(null=True, blank=True)
    informe_ambiente = models.DateField(null=True, blank=True)
    proyecto = models.TextField(null=True, blank=True)

    class Meta:
        managed = False
        db_table = "servidumbres"
...
class Convenios(models.Model):
    id = models.BigIntegerField(primary_key=True)  # int8
    expediente = models.TextField(blank=True, null=True)
    geom = models.TextField(blank=True, null=True)
    superficie = models.TextField(blank=True, null=True)
    tipo = models.TextField(blank=True, null=True)
    nombre = models.TextField(blank=True, null=True)
    concesionario = models.TextField(blank=True, null=True)
    resolucion = models.TextField(blank=True, null=True)

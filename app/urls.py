...
urlpatterns = [
    ...
    path('ver-contrato-pdf/<int:contrato_id>/', views.ver_archivo_contrato, name='ver_contrato'),
    ...
    path('proveedores/tramite/new',views.new_tramite_view, name='new_tramite'),
    path('proveedores/buscar/<str:cuit>/',views.buscar_proveedor_view,name='buscar_proveedor'),
    path('proveedores/simsa/ddjj_report/',views.analisis_proveedores_ddjj,name='proveedores_simsa_report'),
